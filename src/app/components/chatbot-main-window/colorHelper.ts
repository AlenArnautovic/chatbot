export function returnColorForQuestions(themeName:string, inHex:boolean):string{
    switch(themeName){
        case "lara-dark-blue":
...
export function returnColorForAnswers(themeName:string, inHex:boolean):string{
