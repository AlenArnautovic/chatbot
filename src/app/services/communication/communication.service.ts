...
async insertTestData(
  ...
  async checkPatientsData(age: number,prename:string,lastname:string,vNumber:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
    ...
    async checkIfPatientHasAppointmentForDisease(vNumber:string, disease:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
        this.http.post(`${this.baseServerUrl}database/checkIfPatientHasAppointmentForDisease`,{            
          vNumber,
          disease,
          userId: this.getClientId(),
        })
    ...
    async checkIfPatientHasAppointmentAtTime(vNumber:string, appointment:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
        this.http.post(`${this.baseServerUrl}database/checkIfPatientHasAppointmentAtTime`,{            
          vNumber,
          appointment,
          userId: this.getClientId(),
        })
    ...
    async checkIfDoctorForDiseaseIsAvailable(disease:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
        this.http.post(`${this.baseServerUrl}database/checkIfDoctorForDiseaseIsAvailable`,{            
          disease,
          userId: this.getClientId(),
        })
      )) as chatbotTransportObject;
    ...
    async checkIfDoctorForDiseaseIsAvailableForASpecificAppointment(disease:string, appointment:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
        this.http.post(`${this.baseServerUrl}database/checkIfDoctorForDiseaseIsAvailableForASpecificAppointment`,{            
          disease,
          appointment,
          userId: this.getClientId(),
        })
    ...
    async getInformationOfAppointment(vNumber:string, appointment:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
        this.http.post(`${this.baseServerUrl}database/getInformationOfAppointment`,{            
          vNumber,
          appointment,
          userId: this.getClientId(),
        })
    ...
    async bookAppointment(vNumber:string, appointment:string, disease:string,symptoms:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
    ...
    async changeAppointment(vNumber:string, disease:string, oldAppointment:string, newAppointment:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
    ...
    async deleteAppointment(vNumber:string, appointment:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
    ...
    async addPatient(vNumber:string, preName:string,lastName:string, phone:string, birthdate:string, address_ID:string): Promise<chatbotTransportObject> {
      const response: chatbotTransportObject = (await firstValueFrom(
