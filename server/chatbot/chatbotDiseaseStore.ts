...
export class chatbotDiseaseStore {
  ...
  constructor() {
    chatbotDiseaseStore.backpain_red.choices =
      chatbotDiseaseStore.initializeBackPainRed();
    chatbotDiseaseStore.backpain_orange.choices =
      chatbotDiseaseStore.initializeBackPainOrange();
    chatbotDiseaseStore.backpain_yellow.choices =
